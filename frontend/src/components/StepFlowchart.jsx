      ...
      <div className="relative pl-6 space-y-4">
        ...
        {steps.map((step, idx) => (
          <div key={idx} className="relative group">
            ...
            {/* Step Card */}
            <div className="p-3 bg-white dark:bg-[#121216] border border-zinc-200/80 dark:border-zinc-800 rounded-lg shadow-2xs hover:border-blue-400/50 dark:hover:border-blue-500/30 transition-colors">
                ...
                {step.tables && step.tables.length > 0 && (
                  <div className="flex flex-wrap gap-1 items-center">
                    {step.tables.map((tbl, tIdx) => (
                      <span 
                        key={tIdx} 
                        className="px-1.5 py-0.5 rounded bg-blue-50 dark:bg-blue-950/40 text-blue-600 dark:text-blue-400 text-[10px] border border-blue-200/50 dark:border-blue-900/40 flex items-center space-x-1"
                      >
                        <Database size={9} />
                        <span>{tbl}</span>
                      </span>
